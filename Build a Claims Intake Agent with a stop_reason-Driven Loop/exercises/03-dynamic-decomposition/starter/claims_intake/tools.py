...
TOOL_SCHEMAS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "description": (
            "Ask the claimant one clarifying question when the claim type is genuinely ambiguous. "
            "Return the scripted claimant answer if available; otherwise return NO_RESPONSE."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "description": (
            "Terminal tool: escalate the case to a human adjuster when confidence is too low, the claim is ambiguous, "
            "or routing would be unsafe."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
